...
namespace keyboard {
    ...
    //% to.min=0 to.max=15
    //% to.defl=15
    //% blockId=led_range block="Set LED range from|%from to|%to"
    ...
    //% blockId=set_index_color block="Set the|%index|LED color|%rgb"
    ...
    //% blockId=led_rainbow block="Show rainbow LED from|%startLed to|%endLed and set color from|%startHue to|%endHue"
    ...
    //% weight=57
    //% blockId=kb_event block="|%value|is pressed"
